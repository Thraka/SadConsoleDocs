...
<Aside type="tip">
If you're planning on using Visual Studio to create the project, Visual Studio automatically imports .NET templates you installed in the previous section. If you want to create a project using Visual Studio, see [Create a new SadConsole project with Visual Studio](getting-started-visualstudio.md).

Note that it is quicker to create a project with the CLI and then open it in Visual Studio than it is to create the project with Visual Studio.
</Aside>
