...
01. In the **Create a new project** dialog, type `sadconsole` into the search box and select the **SadConsole Game (MonoGame)** project template.
    ...
    ![create a new SadConsole project in visual studio](/article-assets/images/getting-started/visualstudio/template.png)
...
![a new console in SadConsole with hello text](/article-assets/images/getting-started/visualstudio/hello-window.png)
