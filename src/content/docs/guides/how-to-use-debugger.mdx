---
title: How to enable the SadConsole debugger
...
import snippet1 from './snippets/how-to-use-debugger/csharp/Program.cs?raw';

<Code code={snippet1} lang="csharp" mark={11} />

Once the game is running, press the referenced key, F12 in this example, and the SadConsole Debugger turns on.

![A SadConsole screen with the SadConsole Debugger turned on.](/article-assets/images/guides/how-to-use-debugger/example.png)
