---
title: CursorRenderStep Class
slug: reference/sadconsole.renderers.cursorrenderstep
sidebar:
  label: CursorRenderStep
---
## Definition
...
Sets the [Cursor](../sadconsole.components.cursor/).
...
A <xref href="SadConsole.Components.Cursor" data-throw-if-not-resolved="false"></xref> object.
