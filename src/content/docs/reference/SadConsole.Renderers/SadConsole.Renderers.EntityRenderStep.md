...
editUrl: false
description: Draws the entities of a `SadConsole.Entities.EntityManager`.
---
## Definition
...
A [EntityManager](../sadconsole.entities.entitymanager/) object.
...
<a href="https://learn.microsoft.com/dotnet/csharp/language-reference/builtin-types/bool">true</a> to indicate this method was called from [Dispose()](../sadconsole.renderers.entityrenderstep/#dispose).
