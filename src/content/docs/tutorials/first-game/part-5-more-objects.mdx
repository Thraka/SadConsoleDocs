...
<SaveFile title="Download starting project" href="/article-assets/tutorials/first-game/projects/part4.zip" />
...
<SaveFile title="Download example project" href="/article-assets/tutorials/first-game/projects/part5.zip" />
