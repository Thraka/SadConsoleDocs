...
01. Add the `FillBackground` method to the class to fill the map surface with a gradient:
    ...
    ![SadConsole gradient diagram](/article-assets/images/tutorials/first-game/part-3-input/gradient.png)
...
![Smiley face glyph 2](/article-assets/images/tutorials/first-game/part-3-input/smileyface.png)
...
![Moving the player](/article-assets/images/tutorials/first-game/part-3-input/move-player.gif)
...
![Moving the player](/article-assets/images/tutorials/first-game/part-3-input/move-player-clean.gif)
...
<SaveFile title="Download example project" href="/article-assets/files/tutorials/first-game/part3.zip" />
