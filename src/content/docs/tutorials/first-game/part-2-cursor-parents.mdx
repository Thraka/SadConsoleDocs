...
![demonstrating a PowerShell and cmd terminal](/article-assets/images/tutorials/first-game/part-2-cursor-parents/terminal.gif)
...
![child console with cursor displayed](/article-assets/images/tutorials/first-game/part-2-cursor-parents/cyan-cursor-console.png)
...
![console with child surface](/article-assets/images/tutorials/first-game/part-2-cursor-parents/single-console-child-surface.png)
...
![console with child surface](/article-assets/images/tutorials/first-game/part-2-cursor-parents/two-consoles.png)
