...
<SaveFile title="Download starting project" href="/article-assets/files/tutorials/first-game/part3.zip" />
...
![A monster and treasure object on the game map](/article-assets/images/tutorials/first-game/part-4-mapobject/monster-and-treasure.png)
...
<SaveFile title="Download example project" href="/article-assets/files/tutorials/first-game/part4.zip" />
